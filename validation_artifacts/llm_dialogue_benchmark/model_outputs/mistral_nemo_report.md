...
Outputs: `validation_artifacts\llm_dialogue_benchmark\model_outputs\mistral_nemo_outputs.json`
Cases: `5`
...
| `mistral-nemo-instruct-2407 / rag_only` | 2 | 3 | 0.40 | none | policy_compliance:2, revalidation:1, source_update:1 |
| `mistral-nemo-instruct-2407 / validator_only` | 1 | 4 | 0.20 | none | evidence_calibration:2, frame_correction:1, policy_compliance:2, source_update:1, validator_review:1 |
| `mistral-nemo-instruct-2407 / prompt_level_cap` | 1 | 4 | 0.20 | none | evidence_calibration:2, frame_correction:1, policy_compliance:1, revalidation:1 |
| `mistral-nemo-instruct-2407 / proxy_level_cap` | 1 | 4 | 0.20 | none | evidence_calibration:1, policy_compliance:2, revalidation:1, source_update:1, validator_review:1 |
...
| `ldb_03_weak_rag_overclaim` | `weak_rag_overclaim` | False | none | evidence_calibration |
| `ldb_04_stale_cross_turn_anchor` | `stale_anchor` | False | none | revalidation |
| `ldb_05_validator_accepted_weak_claim` | `validator_overtrust` | False | none | evidence_calibration |
